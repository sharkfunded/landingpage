                ...
                <div className="md:col-span-5 min-h-[450px] md:h-[650px] rounded-[32px] bg-gradient-to-b from-[#F9FCFB] to-[#CBE0F0] relative overflow-hidden group p-8 pb-16 flex flex-col justify-end text-left border border-[#E9F0FF]">
                    ...
                    <div className="absolute inset-x-0 top-0 h-[80%] w-full flex items-center justify-center pointer-events-none">
                        <img
                            ...
                            className="absolute top-1/2 left-[41%] -translate-x-1/2 -translate-y-1/2 scale-110"
                        />
                    </div>
                    ...
                    <div className="h-[288px] rounded-[32px] bg-gradient-to-b from-[#F9FCFB] to-[#CBE0F0] relative overflow-hidden group p-8 flex items-center justify-between border border-[#E9F0FF]">
                        ...
                        <div className="absolute right-0 top-0 bottom-0 w-[55%] h-full pointer-events-none">
                            <img
                                ...
                                alt="Daily Payouts"
                                className="absolute right-0 top-0 h-full w-full object-contain object-right-bottom scale-110"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="h-full rounded-[32px] bg-gradient-to-b from-[#F9FCFB] to-[#CBE0F0] relative overflow-hidden group p-8 flex flex-col justify-start text-center items-center border border-[#E9F0FF]">
                            ...
                            <div className="absolute inset-x-0 top-0 h-full w-full flex items-center justify-center pointer-events-none">
                                <img
                                    ...
                                    alt="300+ Instruments"
                                    className="w-[80%] max-w-none object-contain translate-y-8"
                                />
                            </div>
                        </div>
                        ...
                        <div className="h-full rounded-[32px] bg-gradient-to-b from-[#F9FCFB] to-[#CBE0F0] relative overflow-hidden group p-8 pb-3 flex flex-col justify-end text-center items-center border border-[#E9F0FF]">
                            <div className="absolute inset-x-0 top-0 h-full w-full flex items-center justify-center pointer-events-none">
                                ...
                                <div className="absolute w-[150px] h-[150px] rounded-full bg-gradient-to-b from-[rgba(0,58,167,0)] to-[rgba(0,58,167,0.23)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
