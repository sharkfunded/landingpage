    ...
    return (
        <section className="w-full bg-[#030511] py-20 px-4 relative overflow-hidden text-center z-10">
            ...
            <div className="absolute inset-x-0 top-0 h-full z-20 mix-blend-screen pointer-events-none overflow-hidden">
                <ParallaxBlock offset={-50} className="w-full h-full">
                    <img
                        alt="Background Rays"
                        className="absolute top-[-25%] left-1/2 -translate-x-1/2 w-full max-w-none h-[120%] object-cover opacity-60"
                ...
                <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    ...
                    <StaggerItem className="rounded-[32px] bg-gradient-to-b from-[#0E1235] to-[#040510] border border-white/10 p-1 flex flex-col relative group overflow-hidden h-[500px]">
                        ...
                        <div className="absolute top-8 left-8 z-30 pointer-events-none">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/40 backdrop-blur-md text-white/90 text-xs font-medium border border-white/10 shadow-lg">
                        ...
                        <div className="relative flex-1 w-full flex items-center justify-center overflow-hidden min-h-[200px]">
                            <ParallaxBlock offset={-20} className="w-full h-full flex items-center justify-center">
                                <div className="absolute inset-0 mix-blend-screen pointer-events-none">
                                    <img
                                        alt="Evaluation Step"
                                        className="absolute h-[130.9%] left-[-40.94%] max-w-none top-[-10.68%] w-[183.41%] object-cover pointer-events-none scale-[0.85] transition-transform duration-700 group-hover:scale-[0.9]"
                            ...
                            <ParallaxBlock offset={20} className="w-full h-full flex items-center justify-center">
                                <div className="absolute inset-0 mix-blend-screen pointer-events-none">
                                    <img
                                        ...
                                        className="absolute h-[171.35%] left-[-62.47%] max-w-none top-[-39.16%] w-[201.89%] object-cover pointer-events-none scale-[0.85] transition-transform duration-700 group-hover:scale-[0.9]"
                    ...
                    <StaggerItem className="rounded-[32px] bg-gradient-to-b from-[#0E1235] to-[#040510] border border-white/10 p-1 flex flex-col relative group overflow-hidden h-[500px]">
                        ...
                        <div className="relative flex-1 w-full flex items-center justify-center overflow-hidden min-h-[200px]">
                            <ParallaxBlock offset={-30} className="w-full h-full flex items-center justify-center">
                                <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                                    <img
                                        alt="Payout Pockets"
                                        className="w-[120%] h-auto object-contain max-w-none transition-transform duration-700 group-hover:translate-y-[-10px]"
