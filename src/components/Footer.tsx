                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 py-20">
                    ...
                    <div className="col-span-1 md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col gap-6">
                            <h4 className="font-bold text-xl">Pages 01</h4>
                            <ul className="flex flex-col gap-4 text-gray-500 text-base">
                                <li><a href="#" className="hover:text-white transition-colors">Home</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">Feature</a></li>
                        ...
                        {/* Column 2 */}
                        <div className="flex flex-col gap-6">
                            <h4 className="font-bold text-xl">Pages 02</h4>
                            <ul className="flex flex-col gap-4 text-gray-500 text-base">
                                ...
                                <li><a href="#" className="hover:text-white transition-colors">Single Integration</a></li>
                            </ul>
                        </div>
                        {/* Column 3 */}
                        <div className="flex flex-col gap-6">
                            <h4 className="font-bold text-xl">Utility</h4>
                            <ul className="flex flex-col gap-4 text-gray-500 text-base">
                                <li><a href="#" className="hover:text-white transition-colors">Changelog</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">404</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">Lisence</a></li>
